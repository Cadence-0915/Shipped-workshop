...
My app currently allows the following:
	...
	**Users cannot currently add jobs to their boats. I did create a job table, a jobs controller, and a job model. 
	
	Validations are set up, so boat names must be unique and boat locations are hard-coded.

	Part 2

	**Users cannot follow other ships. Users cannot see what ships they're following. 

	When users click 'View your Boats', they can see the picture of their boat they chose when adding the boat.
