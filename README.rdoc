...
My app currently allows the following:
	...
	**Users cannot currently add jobs to their boats because I'm not entirely sure how to add this functionality.  I have created a job table, a jobs controller, and a job model. I also set job validations so jobs must have a unique name, cost must be above $1000 for each job, the cargo description must be at least 50 characters, the
	...
	**Users cannot follow other ships. Users cannot see what ships they're following. 
	...
	When users click 'View your Boats', they can see the picture of their boat they chose when they first added the boat.
